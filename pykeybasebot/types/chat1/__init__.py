...
class ChatChannel(DataClassJsonMixin):
    ...
    members_type: Optional[str] = field(default=None, metadata=config(field_name='members_type'))
    topic_type: Optional[str] = field(default=None, metadata=config(field_name='topic_type'))
    topic_name: Optional[str] = field(default=None, metadata=config(field_name='topic_name'))
...
class MsgSender(DataClassJsonMixin):
    ...
    device_id: keybase1.DeviceID = field(metadata=config(field_name='device_id'))
...
@dataclass
class MsgBotInfo(DataClassJsonMixin):
    bot_uid: keybase1.UID = field(metadata=config(field_name='bot_uid'))
    bot_username: Optional[str] = field(default=None, metadata=config(field_name='bot_username'))
...
class UIInboxReselectInfo(DataClassJsonMixin):
    ...
    new_conv_id: Optional[str] = field(default=None, metadata=config(field_name='newConvID'))
...
class UIAssetUrlInfo(DataClassJsonMixin):
    ...
    inline_video_playable: bool = field(metadata=config(field_name='inlineVideoPlayable'))
    video_duration: Optional[str] = field(default=None, metadata=config(field_name='videoDuration'))
...
class UIPaymentInfo(DataClassJsonMixin):
    ...
    account_id: Optional[stellar1.AccountID] = field(default=None, metadata=config(field_name='accountID'))
...
class UIRequestInfo(DataClassJsonMixin):
    ...
    asset: Optional[stellar1.Asset] = field(default=None, metadata=config(field_name='asset'))
    currency: Optional[stellar1.OutsideCurrencyCode] = field(default=None, metadata=config(field_name='currency'))
...
class UITeamMention(DataClassJsonMixin):
    ...
    num_members: Optional[int] = field(default=None, metadata=config(field_name='numMembers'))
    public_admins: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='publicAdmins'))
...
UIChatThreadStatus = Union[UIChatThreadStatus__NONE, UIChatThreadStatus__SERVER, UIChatThreadStatus__VALIDATING, UIChatThreadStatus__VALIDATED]
...
class UIChatPayment(DataClassJsonMixin):
    ...
    display_amount: Optional[str] = field(default=None, metadata=config(field_name='displayAmount'))
...
class UICoinFlipHand(DataClassJsonMixin):
    ...
    hand: Optional[Optional[List[int]]] = field(default=None, metadata=config(field_name='hand'))
...
class Pagination(DataClassJsonMixin):
    ...
    previous: Optional[str] = field(default=None, metadata=config(field_name='previous'))
    last: Optional[bool] = field(default=None, metadata=config(field_name='last'))
    force_first_page: Optional[bool] = field(default=None, metadata=config(field_name='forceFirstPage'))
...
@dataclass
class ConversationJourneycardInfo(DataClassJsonMixin):
    welcome_eligible: bool = field(metadata=config(field_name='w'))
...
class AssetMetadataImage(DataClassJsonMixin):
    ...
    audio_amps: Optional[Optional[List[float]]] = field(default=None, metadata=config(field_name='audioAmps'))
...
class AssetMetadataVideo(DataClassJsonMixin):
    ...
    is_audio: bool = field(metadata=config(field_name='isAudio'))
...
class MessageSystemAddedToTeam(DataClassJsonMixin):
    ...
    role: keybase1.TeamRole = field(metadata=config(field_name='role'))
    bulk_adds: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='bulkAdds'))
    owners: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='owners'))
    admins: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='admins'))
    ...
    bots: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='bots'))
    restricted_bots: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='restrictedBots'))
...
class MessageSystemInviteAddedToTeam(DataClassJsonMixin):
    ...
    adder: str = field(metadata=config(field_name='adder'))
    invite_type: keybase1.TeamInviteCategory = field(metadata=config(field_name='inviteType'))
    role: keybase1.TeamRole = field(metadata=config(field_name='role'))
...
class MessageSystemGitPush(DataClassJsonMixin):
    ...
    refs: Optional[Optional[List[keybase1.GitRefMetadata]]] = field(default=None, metadata=config(field_name='refs'))
...
class MessageSystemBulkAddToConv(DataClassJsonMixin):
    usernames: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='usernames'))
...
class MessageJoin(DataClassJsonMixin):
    joiners: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='joiners'))
    leavers: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='leavers'))
...
class MessageRequestPayment(DataClassJsonMixin):
    request_id: stellar1.KeybaseRequestID = field(metadata=config(field_name='requestID'))
    note: str = field(metadata=config(field_name='note'))
...
class JourneycardTypeStrings(Enum):
    WELCOME = 'welcome'
...
class ConversationLocalParticipant(DataClassJsonMixin):
    username: str = field(metadata=config(field_name='username'))
    in_conv_name: bool = field(metadata=config(field_name='inConvName'))
    fullname: Optional[str] = field(default=None, metadata=config(field_name='fullname'))
    contact_name: Optional[str] = field(default=None, metadata=config(field_name='contactName'))
...
class ConversationErrorRekey(DataClassJsonMixin):
    ...
    rekeyers: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='rekeyers'))
    writer_names: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='writerNames'))
    reader_names: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='readerNames'))
...
class InboxLayoutReselectMode(Enum):
    DEFAULT = 0
    FORCE = 1

class InboxLayoutReselectModeStrings(Enum):
    DEFAULT = 'default'
    FORCE = 'force'
...
PreviewLocation = Union[PreviewLocation__URL, PreviewLocation__FILE, PreviewLocation__BYTES]
...
UnfurlPromptResult = Union[UnfurlPromptResult__ALWAYS, UnfurlPromptResult__NEVER, UnfurlPromptResult__NOTNOW, UnfurlPromptResult__ACCEPT, UnfurlPromptResult__ONETIME]
...
class SnippetDecorationStrings(Enum):
    NONE = 'none'
...
class S3Params(DataClassJsonMixin):
    ...
    region_bucket_endpoint: str = field(metadata=config(field_name='regionBucketEndpoint'))
...
SyncAllNotificationRes = Union[SyncAllNotificationRes__STATE, SyncAllNotificationRes__INCREMENTAL]
...
class MsgFlipContent(DataClassJsonMixin):
    ...
    user_mentions: Optional[Optional[List[KnownUserMention]]] = field(default=None, metadata=config(field_name='user_mentions'))
    team_mentions: Optional[Optional[List[KnownTeamMention]]] = field(default=None, metadata=config(field_name='team_mentions'))
...
class ConvSummary(DataClassJsonMixin):
    ...
    reset_users: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='reset_users'))
    finalize_info: Optional[ConversationFinalizeInfo] = field(default=None, metadata=config(field_name='finalize_info'))
    supersedes: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='supersedes'))
    superseded_by: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='superseded_by'))
    error: Optional[str] = field(default=None, metadata=config(field_name='error'))

@dataclass
class SendRes(DataClassJsonMixin):
    message: str = field(metadata=config(field_name='message'))
    message_id: Optional[MessageID] = field(default=None, metadata=config(field_name='id'))
    outbox_id: Optional[OutboxID] = field(default=None, metadata=config(field_name='outbox_id'))
    identify_failures: Optional[Optional[List[keybase1.TLFIdentifyFailure]]] = field(default=None, metadata=config(field_name='identify_failures'))
    rate_limits: Optional[Optional[List[RateLimitRes]]] = field(default=None, metadata=config(field_name='ratelimits'))
...
class GetDeviceInfoRes(DataClassJsonMixin):
    devices: Optional[Optional[List[DeviceInfo]]] = field(default=None, metadata=config(field_name='devices'))
...
class UIInboxSmallTeamRow(DataClassJsonMixin):
    ...
    snippet_decoration: SnippetDecoration = field(metadata=config(field_name='snippetDecoration'))
    is_muted: bool = field(metadata=config(field_name='isMuted'))
...
class UnverifiedInboxUIItemMetadata(DataClassJsonMixin):
    ...
    snippet_decoration: SnippetDecoration = field(metadata=config(field_name='snippetDecoration'))
    writer_names: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='writerNames'))
    reset_participants: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='resetParticipants'))
...
class UIParticipant(DataClassJsonMixin):
    ...
    in_conv_name: bool = field(metadata=config(field_name='inConvName'))
    full_name: Optional[str] = field(default=None, metadata=config(field_name='fullName'))
    contact_name: Optional[str] = field(default=None, metadata=config(field_name='contactName'))
...
class UIMessageJourneycard(DataClassJsonMixin):
    ...
    highlight_msg_id: MessageID = field(metadata=config(field_name='highlightMsgID'))
    open_team: bool = field(metadata=config(field_name='openTeam'))
...
UIMaybeMentionInfo = Union[UIMaybeMentionInfo__UNKNOWN, UIMaybeMentionInfo__USER, UIMaybeMentionInfo__TEAM, UIMaybeMentionInfo__NOTHING]
...
class UIChatPaymentSummary(DataClassJsonMixin):
    ...
    payments: Optional[Optional[List[UIChatPayment]]] = field(default=None, metadata=config(field_name='payments'))

@dataclass
class GiphySearchResults(DataClassJsonMixin):
    gallery_url: str = field(metadata=config(field_name='galleryUrl'))
    results: Optional[Optional[List[GiphySearchResult]]] = field(default=None, metadata=config(field_name='results'))

@dataclass
class UICoinFlipAbsenteeError(DataClassJsonMixin):
    absentees: Optional[Optional[List[UICoinFlipErrorParticipant]]] = field(default=None, metadata=config(field_name='absentees'))
...
UICoinFlipResult = Union[UICoinFlipResult__NUMBER, UICoinFlipResult__SHUFFLE, UICoinFlipResult__DECK, UICoinFlipResult__HANDS, UICoinFlipResult__COIN]

@dataclass
class ConversationCommandGroupsCustom(DataClassJsonMixin):
    commands: Optional[Optional[List[ConversationCommand]]] = field(default=None, metadata=config(field_name='commands'))
...
class GetInboxQuery(DataClassJsonMixin):
    ...
    allow_unseen_query: bool = field(metadata=config(field_name='allowUnseenQuery'))
    conv_id: Optional[ConversationID] = field(default=None, metadata=config(field_name='convID'))
    topic_type: Optional[TopicType] = field(default=None, metadata=config(field_name='topicType'))
    tlf_id: Optional[TLFID] = field(default=None, metadata=config(field_name='tlfID'))
    tlf_visibility: Optional[keybase1.TLFVisibility] = field(default=None, metadata=config(field_name='tlfVisibility'))
    before: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='before'))
    after: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='after'))
    one_chat_type_per_tlf: Optional[bool] = field(default=None, metadata=config(field_name='oneChatTypePerTLF'))
    topic_name: Optional[str] = field(default=None, metadata=config(field_name='topicName'))
    status: Optional[Optional[List[ConversationStatus]]] = field(default=None, metadata=config(field_name='status'))
    member_status: Optional[Optional[List[ConversationMemberStatus]]] = field(default=None, metadata=config(field_name='memberStatus'))
    existences: Optional[Optional[List[ConversationExistence]]] = field(default=None, metadata=config(field_name='existences'))
    members_types: Optional[Optional[List[ConversationMembersType]]] = field(default=None, metadata=config(field_name='membersTypes'))
    conv_i_ds: Optional[Optional[List[ConversationID]]] = field(default=None, metadata=config(field_name='convIDs'))
...
class ConversationReaderInfo(DataClassJsonMixin):
    ...
    untrusted_team_role: keybase1.TeamRole = field(metadata=config(field_name='untrustedTeamRole'))
    journeycard: Optional[ConversationJourneycardInfo] = field(default=None, metadata=config(field_name='jc'))

@dataclass
class ConversationSettings(DataClassJsonMixin):
    min_writer_role_info: Optional[ConversationMinWriterRoleInfo] = field(default=None, metadata=config(field_name='mwr'))
...
class MessageServerHeader(DataClassJsonMixin):
    ...
    reaction_i_ds: Optional[Optional[List[MessageID]]] = field(default=None, metadata=config(field_name='r'))
    unfurl_i_ds: Optional[Optional[List[MessageID]]] = field(default=None, metadata=config(field_name='u'))
    replies: Optional[Optional[List[MessageID]]] = field(default=None, metadata=config(field_name='replies'))
    rtime: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='rt'))
...
RetentionPolicy = Union[RetentionPolicy__RETAIN, RetentionPolicy__EXPIRE, RetentionPolicy__INHERIT, RetentionPolicy__EPHEMERAL]
...
class SearchOpts(DataClassJsonMixin):
    ...
    initial_pagination: Optional[Pagination] = field(default=None, metadata=config(field_name='initialPagination'))
    conv_id: Optional[ConversationID] = field(default=None, metadata=config(field_name='convID'))
...
AssetMetadata = Union[AssetMetadata__IMAGE, AssetMetadata__VIDEO]

@dataclass
class UnreadUpdate(DataClassJsonMixin):
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    unread_messages: int = field(metadata=config(field_name='unreadMessages'))
    unread_notifying_messages: Dict[str, int] = field(metadata=config(field_name='unreadNotifyingMessages'))
...
class TLFFinalizeUpdate(DataClassJsonMixin):
    finalize_info: ConversationFinalizeInfo = field(metadata=config(field_name='finalizeInfo'))
...
@dataclass
class TeamMemberRoleUpdate(DataClassJsonMixin):
...
class MessageEdit(DataClassJsonMixin):
    message_id: MessageID = field(metadata=config(field_name='messageID'))
    body: str = field(metadata=config(field_name='body'))
    user_mentions: Optional[Optional[List[KnownUserMention]]] = field(default=None, metadata=config(field_name='userMentions'))
    team_mentions: Optional[Optional[List[KnownTeamMention]]] = field(default=None, metadata=config(field_name='teamMentions'))

@dataclass
class MessageDelete(DataClassJsonMixin):
    message_i_ds: Optional[Optional[List[MessageID]]] = field(default=None, metadata=config(field_name='messageIDs'))
...
class SenderPrepareOptions(DataClassJsonMixin):
    skip_topic_name_state: bool = field(metadata=config(field_name='skipTopicNameState'))
    reply_to: Optional[MessageID] = field(default=None, metadata=config(field_name='replyTo'))

@dataclass
class SenderSendOptions(DataClassJsonMixin):
    join_mentions_as: Optional[ConversationMemberStatus] = field(default=None, metadata=config(field_name='joinMentionsAs'))
...
class MessageUnboxedError(DataClassJsonMixin):
    ...
    exploded_by: Optional[str] = field(default=None, metadata=config(field_name='explodedBy'))
...
@dataclass
class MessageUnboxedJourneycard(DataClassJsonMixin):
    prev_id: MessageID = field(metadata=config(field_name='prevID'))
    ordinal: int = field(metadata=config(field_name='ordinal'))
    card_type: JourneycardType = field(metadata=config(field_name='cardType'))
    highlight_msg_id: MessageID = field(metadata=config(field_name='highlightMsgID'))
    open_team: bool = field(metadata=config(field_name='openTeam'))
...
class ConversationSettingsLocal(DataClassJsonMixin):
    min_writer_role_info: Optional[ConversationMinWriterRoleInfoLocal] = field(default=None, metadata=config(field_name='minWriterRoleInfo'))

@dataclass
class NonblockFetchRes(DataClassJsonMixin):
    offline: bool = field(metadata=config(field_name='offline'))
    rate_limits: Optional[Optional[List[RateLimit]]] = field(default=None, metadata=config(field_name='rateLimits'))
    identify_failures: Optional[Optional[List[keybase1.TLFIdentifyFailure]]] = field(default=None, metadata=config(field_name='identifyFailures'))

@dataclass
class MessageIDControl(DataClassJsonMixin):
    mode: MessageIDControlMode = field(metadata=config(field_name='mode'))
    num: int = field(metadata=config(field_name='num'))
    pivot: Optional[MessageID] = field(default=None, metadata=config(field_name='pivot'))
...
class UnreadlineRes(DataClassJsonMixin):
    ...
    rate_limits: Optional[Optional[List[RateLimit]]] = field(default=None, metadata=config(field_name='rateLimits'))
    identify_failures: Optional[Optional[List[keybase1.TLFIdentifyFailure]]] = field(default=None, metadata=config(field_name='identifyFailures'))
    unreadline_id: Optional[MessageID] = field(default=None, metadata=config(field_name='unreadlineID'))

@dataclass
class NameQuery(DataClassJsonMixin):
    name: str = field(metadata=config(field_name='name'))
    members_type: ConversationMembersType = field(metadata=config(field_name='membersType'))
    tlf_id: Optional[TLFID] = field(default=None, metadata=config(field_name='tlfID'))
...
class EditTarget(DataClassJsonMixin):
    message_id: Optional[MessageID] = field(default=None, metadata=config(field_name='messageID'))
    outbox_id: Optional[OutboxID] = field(default=None, metadata=config(field_name='outboxID'))
...
class GetInboxSummaryForCLILocalQuery(DataClassJsonMixin):
    ...
    unread_first_limit: UnreadFirstNumLimit = field(metadata=config(field_name='unreadFirstLimit'))
    activity_sorted_limit: int = field(metadata=config(field_name='activitySortedLimit'))
    status: Optional[Optional[List[ConversationStatus]]] = field(default=None, metadata=config(field_name='status'))
    conv_i_ds: Optional[Optional[List[ConversationID]]] = field(default=None, metadata=config(field_name='convIDs'))
...
class ProfileSearchConvStats(DataClassJsonMixin):
    ...
    duration_msec: gregor1.DurationMsec = field(metadata=config(field_name='durationMsec'))
    percent_indexed: int = field(metadata=config(field_name='percentIndexed'))
...
class UserBotCommandOutput(DataClassJsonMixin):
    ...
    usage: str = field(metadata=config(field_name='usage'))
    username: str = field(metadata=config(field_name='username'))
    extended_description: Optional[UserBotExtendedDescription] = field(default=None, metadata=config(field_name='extended_description'))
...
class SetAppNotificationSettingsInfo(DataClassJsonMixin):
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    settings: ConversationNotificationInfo = field(metadata=config(field_name='settings'))
...
class ConvTypingUpdate(DataClassJsonMixin):
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    typers: Optional[Optional[List[TyperInfo]]] = field(default=None, metadata=config(field_name='typers'))
...
class NewConversationRemoteRes(DataClassJsonMixin):
    ...
    rate_limit: Optional[RateLimit] = field(default=None, metadata=config(field_name='rateLimit'))
...
class UnfurlGenericRaw(DataClassJsonMixin):
    ...
    favicon_url: Optional[str] = field(default=None, metadata=config(field_name='faviconUrl'))
    image_url: Optional[str] = field(default=None, metadata=config(field_name='imageUrl'))
    video: Optional[UnfurlVideo] = field(default=None, metadata=config(field_name='video'))
    publish_time: Optional[int] = field(default=None, metadata=config(field_name='publishTime'))
    description: Optional[str] = field(default=None, metadata=config(field_name='description'))
...
class UnfurlMapsRaw(DataClassJsonMixin):
    ...
    history_image_url: Optional[str] = field(default=None, metadata=config(field_name='historyImageUrl'))
    live_location_end_time: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='liveLocationEndTime'))

@dataclass
class UnfurlGenericMapInfo(DataClassJsonMixin):
    coord: Coordinate = field(metadata=config(field_name='coord'))
    time: gregor1.Time = field(metadata=config(field_name='time'))
    is_live_location_done: bool = field(metadata=config(field_name='isLiveLocationDone'))
    live_location_end_time: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='liveLocationEndTime'))

@dataclass
class UnfurlGiphyDisplay(DataClassJsonMixin):
    favicon: Optional[UnfurlImageDisplay] = field(default=None, metadata=config(field_name='favicon'))
    image: Optional[UnfurlImageDisplay] = field(default=None, metadata=config(field_name='image'))
    video: Optional[UnfurlImageDisplay] = field(default=None, metadata=config(field_name='video'))
...
class UnfurlSettingsDisplay(DataClassJsonMixin):
    mode: UnfurlMode = field(metadata=config(field_name='mode'))
    whitelist: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='whitelist'))

@dataclass
class ChatList(DataClassJsonMixin):
    offline: bool = field(metadata=config(field_name='offline'))
    conversations: Optional[Optional[List[ConvSummary]]] = field(default=None, metadata=config(field_name='conversations'))
    identify_failures: Optional[Optional[List[keybase1.TLFIdentifyFailure]]] = field(default=None, metadata=config(field_name='identify_failures'))
    rate_limits: Optional[Optional[List[RateLimitRes]]] = field(default=None, metadata=config(field_name='ratelimits'))

@dataclass
class ListCommandsRes(DataClassJsonMixin):
    commands: Optional[Optional[List[UserBotCommandOutput]]] = field(default=None, metadata=config(field_name='commands'))
    rate_limits: Optional[Optional[List[RateLimitRes]]] = field(default=None, metadata=config(field_name='ratelimits'))

@dataclass
class ConvNotification(DataClassJsonMixin):
    type: str = field(metadata=config(field_name='type'))
    conv: Optional[ConvSummary] = field(default=None, metadata=config(field_name='conv'))
    error: Optional[str] = field(default=None, metadata=config(field_name='error'))

@dataclass
class AdvertiseCommandAPIParam(DataClassJsonMixin):
    typ: str = field(metadata=config(field_name='type'))
    commands: Optional[Optional[List[UserBotCommandInput]]] = field(default=None, metadata=config(field_name='commands'))
    team_name: Optional[str] = field(default=None, metadata=config(field_name='team_name'))

@dataclass
class GetResetConvMembersRes(DataClassJsonMixin):
    members: Optional[Optional[List[ResetConvMemberAPI]]] = field(default=None, metadata=config(field_name='members'))
    rate_limits: Optional[Optional[List[RateLimitRes]]] = field(default=None, metadata=config(field_name='rateLimits'))

@dataclass
class UIInboxLayout(DataClassJsonMixin):
    total_small_teams: int = field(metadata=config(field_name='totalSmallTeams'))
    small_teams: Optional[Optional[List[UIInboxSmallTeamRow]]] = field(default=None, metadata=config(field_name='smallTeams'))
    big_teams: Optional[Optional[List[UIInboxBigTeamRow]]] = field(default=None, metadata=config(field_name='bigTeams'))
    reselect_info: Optional[UIInboxReselectInfo] = field(default=None, metadata=config(field_name='reselectInfo'))
    widget_list: Optional[Optional[List[UIInboxSmallTeamRow]]] = field(default=None, metadata=config(field_name='widgetList'))
...
UITextDecoration = Union[UITextDecoration__PAYMENT, UITextDecoration__ATMENTION, UITextDecoration__CHANNELNAMEMENTION, UITextDecoration__MAYBEMENTION, UITextDecoration__LINK, UITextDecoration__MAILTO, UITextDecoration__KBFSPATH]

@dataclass
class UIChatSearchConvHits(DataClassJsonMixin):
    unread_matches: bool = field(metadata=config(field_name='unreadMatches'))
    hits: Optional[Optional[List[UIChatSearchConvHit]]] = field(default=None, metadata=config(field_name='hits'))
...
UICoinFlipError = Union[UICoinFlipError__GENERIC, UICoinFlipError__ABSENTEE, UICoinFlipError__TIMEOUT, UICoinFlipError__ABORTED, UICoinFlipError__DUPREG, UICoinFlipError__DUPCOMMITCOMPLETE, UICoinFlipError__DUPREVEAL, UICoinFlipError__COMMITMISMATCH]
...
ConversationCommandGroups = Union[ConversationCommandGroups__BUILTIN, ConversationCommandGroups__CUSTOM, ConversationCommandGroups__NONE]

@dataclass
class ConversationIDMessageIDPairs(DataClassJsonMixin):
    pairs: Optional[Optional[List[ConversationIDMessageIDPair]]] = field(default=None, metadata=config(field_name='pairs'))

@dataclass
class ReactionMap(DataClassJsonMixin):
    reactions: Dict[str, Dict[str, Reaction]] = field(metadata=config(field_name='reactions'))
...
class MessageClientHeader(DataClassJsonMixin):
    ...
    kbfs_crypt_keys_used: Optional[bool] = field(default=None, metadata=config(field_name='kbfsCryptKeysUsed'))
    deletes: Optional[Optional[List[MessageID]]] = field(default=None, metadata=config(field_name='deletes'))
    prev: Optional[Optional[List[MessagePreviousPointer]]] = field(default=None, metadata=config(field_name='prev'))
    delete_history: Optional[MessageDeleteHistory] = field(default=None, metadata=config(field_name='deleteHistory'))
    merkle_root: Optional[MerkleRoot] = field(default=None, metadata=config(field_name='merkleRoot'))
    outbox_id: Optional[OutboxID] = field(default=None, metadata=config(field_name='outboxID'))
    outbox_info: Optional[OutboxInfo] = field(default=None, metadata=config(field_name='outboxInfo'))
    ephemeral_metadata: Optional[MsgEphemeralMetadata] = field(default=None, metadata=config(field_name='em'))
    bot_uid: Optional[gregor1.UID] = field(default=None, metadata=config(field_name='b'))
...
class GenericPayload(DataClassJsonMixin):
    ...
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    topic_type: TopicType = field(metadata=config(field_name='topicType'))
    unread_update: Optional[UnreadUpdate] = field(default=None, metadata=config(field_name='unreadUpdate'))
...
class ExpungePayload(DataClassJsonMixin):
    ...
    topic_type: TopicType = field(metadata=config(field_name='topicType'))
    max_msgs: Optional[Optional[List[MessageSummary]]] = field(default=None, metadata=config(field_name='maxMsgs'))
    unread_update: Optional[UnreadUpdate] = field(default=None, metadata=config(field_name='unreadUpdate'))

@dataclass
class UpdateConversationMembership(DataClassJsonMixin):
    inbox_vers: InboxVers = field(metadata=config(field_name='inboxVers'))
    team_member_role_update: Optional[TeamMemberRoleUpdate] = field(default=None, metadata=config(field_name='teamMemberRoleUpdate'))
    joined: Optional[Optional[List[ConversationMember]]] = field(default=None, metadata=config(field_name='joined'))
    removed: Optional[Optional[List[ConversationMember]]] = field(default=None, metadata=config(field_name='removed'))
    reset: Optional[Optional[List[ConversationMember]]] = field(default=None, metadata=config(field_name='reset'))
    previewed: Optional[Optional[List[ConversationID]]] = field(default=None, metadata=config(field_name='previewed'))
    unread_update: Optional[UnreadUpdate] = field(default=None, metadata=config(field_name='unreadUpdate'))
    unread_updates: Optional[Optional[List[UnreadUpdate]]] = field(default=None, metadata=config(field_name='unreadUpdates'))

@dataclass
class UpdateConversations(DataClassJsonMixin):
    inbox_vers: InboxVers = field(metadata=config(field_name='inboxVers'))
    conv_updates: Optional[Optional[List[ConversationUpdate]]] = field(default=None, metadata=config(field_name='convUpdates'))
...
class SetConvSettingsUpdate(DataClassJsonMixin):
    inbox_vers: InboxVers = field(metadata=config(field_name='inboxVers'))
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    conv_settings: Optional[ConversationSettings] = field(default=None, metadata=config(field_name='convSettings'))

@dataclass
class MessageText(DataClassJsonMixin):
    body: str = field(metadata=config(field_name='body'))
    payments: Optional[Optional[List[TextPayment]]] = field(default=None, metadata=config(field_name='payments'))
    reply_to: Optional[MessageID] = field(default=None, metadata=config(field_name='replyTo'))
    reply_to_uid: Optional[gregor1.UID] = field(default=None, metadata=config(field_name='replyToUID'))
    user_mentions: Optional[Optional[List[KnownUserMention]]] = field(default=None, metadata=config(field_name='userMentions'))
    team_mentions: Optional[Optional[List[KnownTeamMention]]] = field(default=None, metadata=config(field_name='teamMentions'))
    live_location: Optional[LiveLocation] = field(default=None, metadata=config(field_name='liveLocation'))
...
class HeaderPlaintextV1(DataClassJsonMixin):
    ...
    outbox_info: Optional[OutboxInfo] = field(default=None, metadata=config(field_name='outboxInfo'))
    outbox_id: Optional[OutboxID] = field(default=None, metadata=config(field_name='outboxID'))
    header_signature: Optional[SignatureInfo] = field(default=None, metadata=config(field_name='headerSignature'))
    merkle_root: Optional[MerkleRoot] = field(default=None, metadata=config(field_name='merkleRoot'))
    ephemeral_metadata: Optional[MsgEphemeralMetadata] = field(default=None, metadata=config(field_name='em'))
    bot_uid: Optional[gregor1.UID] = field(default=None, metadata=config(field_name='b'))
...
class GetThreadQuery(DataClassJsonMixin):
    ...
    disable_resolve_supersedes: bool = field(metadata=config(field_name='disableResolveSupersedes'))
    enable_delete_placeholders: bool = field(metadata=config(field_name='enableDeletePlaceholders'))
    disable_post_process_thread: bool = field(metadata=config(field_name='disablePostProcessThread'))
    message_types: Optional[Optional[List[MessageType]]] = field(default=None, metadata=config(field_name='messageTypes'))
    before: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='before'))
    after: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='after'))
    message_id_control: Optional[MessageIDControl] = field(default=None, metadata=config(field_name='messageIDControl'))
...
class MakePreviewRes(DataClassJsonMixin):
    mime_type: str = field(metadata=config(field_name='mimeType'))
    preview_mime_type: Optional[str] = field(default=None, metadata=config(field_name='previewMimeType'))
    location: Optional[PreviewLocation] = field(default=None, metadata=config(field_name='location'))
    metadata: Optional[AssetMetadata] = field(default=None, metadata=config(field_name='metadata'))
    base_metadata: Optional[AssetMetadata] = field(default=None, metadata=config(field_name='baseMetadata'))

@dataclass
class GetAllResetConvMembersRes(DataClassJsonMixin):
    members: Optional[Optional[List[ResetConvMember]]] = field(default=None, metadata=config(field_name='members'))
    rate_limits: Optional[Optional[List[RateLimit]]] = field(default=None, metadata=config(field_name='rateLimits'))

@dataclass
class StaticConfig(DataClassJsonMixin):
    deletable_by_delete_history: Optional[Optional[List[MessageType]]] = field(default=None, metadata=config(field_name='deletableByDeleteHistory'))
    builtin_commands: Optional[Optional[List[BuiltinCommandGroup]]] = field(default=None, metadata=config(field_name='builtinCommands'))

@dataclass
class AdvertiseCommandsParam(DataClassJsonMixin):
    typ: BotCommandsAdvertisementTyp = field(metadata=config(field_name='typ'))
    commands: Optional[Optional[List[UserBotCommandInput]]] = field(default=None, metadata=config(field_name='commands'))
    team_name: Optional[str] = field(default=None, metadata=config(field_name='teamName'))
...
class MembersUpdateInfo(DataClassJsonMixin):
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    members: Optional[Optional[List[MemberInfo]]] = field(default=None, metadata=config(field_name='members'))
...
class UnreadUpdateFull(DataClassJsonMixin):
    ...
    inbox_vers: InboxVers = field(metadata=config(field_name='inboxVers'))
    inbox_sync_status: SyncInboxResType = field(metadata=config(field_name='inboxSyncStatus'))
    updates: Optional[Optional[List[UnreadUpdate]]] = field(default=None, metadata=config(field_name='updates'))
...
RemoteBotCommandsAdvertisement = Union[RemoteBotCommandsAdvertisement__PUBLIC, RemoteBotCommandsAdvertisement__TLFID_MEMBERS, RemoteBotCommandsAdvertisement__TLFID_CONVS]

@dataclass
class BotInfo(DataClassJsonMixin):
    server_hash_vers: BotInfoHashVers = field(metadata=config(field_name='serverHashVers'))
    client_hash_vers: BotInfoHashVers = field(metadata=config(field_name='clientHashVers'))
    command_convs: Optional[Optional[List[BotCommandConv]]] = field(default=None, metadata=config(field_name='commandConvs'))
...
UnfurlRaw = Union[UnfurlRaw__GENERIC, UnfurlRaw__YOUTUBE, UnfurlRaw__GIPHY, UnfurlRaw__MAPS]
...
class UnfurlGenericDisplay(DataClassJsonMixin):
    ...
    site_name: str = field(metadata=config(field_name='siteName'))
    favicon: Optional[UnfurlImageDisplay] = field(default=None, metadata=config(field_name='favicon'))
    media: Optional[UnfurlImageDisplay] = field(default=None, metadata=config(field_name='media'))
    publish_time: Optional[int] = field(default=None, metadata=config(field_name='publishTime'))
    description: Optional[str] = field(default=None, metadata=config(field_name='description'))
    map_info: Optional[UnfurlGenericMapInfo] = field(default=None, metadata=config(field_name='mapInfo'))
...
class UICoinFlipStatus(DataClassJsonMixin):
    ...
    commitment_visualization: str = field(metadata=config(field_name='commitmentVisualization'))
    reveal_visualization: str = field(metadata=config(field_name='revealVisualization'))
    participants: Optional[Optional[List[UICoinFlipParticipant]]] = field(default=None, metadata=config(field_name='participants'))
    error_info: Optional[UICoinFlipError] = field(default=None, metadata=config(field_name='errorInfo'))
    result_info: Optional[UICoinFlipResult] = field(default=None, metadata=config(field_name='resultInfo'))
...
MessageSystem = Union[MessageSystem__ADDEDTOTEAM, MessageSystem__INVITEADDEDTOTEAM, MessageSystem__COMPLEXTEAM, MessageSystem__CREATETEAM, MessageSystem__GITPUSH, MessageSystem__CHANGEAVATAR, MessageSystem__CHANGERETENTION, MessageSystem__BULKADDTOCONV, MessageSystem__SBSRESOLVE]
...
class MessageAttachment(DataClassJsonMixin):
    ...
    preview: Optional[Asset] = field(default=None, metadata=config(field_name='preview'))
    previews: Optional[Optional[List[Asset]]] = field(default=None, metadata=config(field_name='previews'))
...
HeaderPlaintext = Union[HeaderPlaintext__V1, HeaderPlaintext__V2, HeaderPlaintext__V3, HeaderPlaintext__V4, HeaderPlaintext__V5, HeaderPlaintext__V6, HeaderPlaintext__V7, HeaderPlaintext__V8, HeaderPlaintext__V9, HeaderPlaintext__V10]

@dataclass
class PostFileAttachmentArg(DataClassJsonMixin):
    conversation_id: ConversationID = field(metadata=config(field_name='conversationID'))
    tlf_name: str = field(metadata=config(field_name='tlfName'))
    visibility: keybase1.TLFVisibility = field(metadata=config(field_name='visibility'))
    filename: str = field(metadata=config(field_name='filename'))
    title: str = field(metadata=config(field_name='title'))
    metadata: str = field(metadata=config(field_name='metadata'))
    identify_behavior: keybase1.TLFIdentifyBehavior = field(metadata=config(field_name='identifyBehavior'))
    caller_preview: Optional[MakePreviewRes] = field(default=None, metadata=config(field_name='callerPreview'))
    outbox_id: Optional[OutboxID] = field(default=None, metadata=config(field_name='outboxID'))
    ephemeral_lifetime: Optional[gregor1.DurationSec] = field(default=None, metadata=config(field_name='ephemeralLifetime'))
...
class MessageBoxed(DataClassJsonMixin):
    ...
    client_header: MessageClientHeader = field(metadata=config(field_name='clientHeader'))
    header_ciphertext: SealedData = field(metadata=config(field_name='headerCiphertext'))
    ...
    server_header: Optional[MessageServerHeader] = field(default=None, metadata=config(field_name='serverHeader'))
...
class UnfurlGeneric(DataClassJsonMixin):
    ...
    url: str = field(metadata=config(field_name='url'))
    site_name: str = field(metadata=config(field_name='siteName'))
    favicon: Optional[Asset] = field(default=None, metadata=config(field_name='favicon'))
...
UnfurlDisplay = Union[UnfurlDisplay__GENERIC, UnfurlDisplay__YOUTUBE, UnfurlDisplay__GIPHY]
...
class ReactionUpdateNotif(DataClassJsonMixin):
    conv_id: ConversationID = field(metadata=config(field_name='convID'))
    user_reacjis: keybase1.UserReacjis = field(metadata=config(field_name='userReacjis'))
    reaction_updates: Optional[Optional[List[ReactionUpdate]]] = field(default=None, metadata=config(field_name='reactionUpdates'))

@dataclass
class ThreadViewBoxed(DataClassJsonMixin):
    messages: Optional[Optional[List[MessageBoxed]]] = field(default=None, metadata=config(field_name='messages'))
...
class GetMessagesRemoteRes(DataClassJsonMixin):
    msgs: Optional[Optional[List[MessageBoxed]]] = field(default=None, metadata=config(field_name='msgs'))
    rate_limit: Optional[RateLimit] = field(default=None, metadata=config(field_name='rateLimit'))
...
class MsgContent(DataClassJsonMixin):
    ...
    text: Optional[MessageText] = field(default=None, metadata=config(field_name='text'))
    attachment: Optional[MessageAttachment] = field(default=None, metadata=config(field_name='attachment'))
    edit: Optional[MessageEdit] = field(default=None, metadata=config(field_name='edit'))
    reaction: Optional[MessageReaction] = field(default=None, metadata=config(field_name='reaction'))
    delete: Optional[MessageDelete] = field(default=None, metadata=config(field_name='delete'))
    metadata: Optional[MessageConversationMetadata] = field(default=None, metadata=config(field_name='metadata'))
    headline: Optional[MessageHeadline] = field(default=None, metadata=config(field_name='headline'))
    attachment_uploaded: Optional[MessageAttachmentUploaded] = field(default=None, metadata=config(field_name='attachment_uploaded'))
    system: Optional[MessageSystem] = field(default=None, metadata=config(field_name='system'))
    send_payment: Optional[MessageSendPayment] = field(default=None, metadata=config(field_name='send_payment'))
    request_payment: Optional[MessageRequestPayment] = field(default=None, metadata=config(field_name='request_payment'))
    unfurl: Optional[MessageUnfurl] = field(default=None, metadata=config(field_name='unfurl'))
    flip: Optional[MsgFlipContent] = field(default=None, metadata=config(field_name='flip'))
...
MessageBody = Union[MessageBody__TEXT, MessageBody__ATTACHMENT, MessageBody__EDIT, MessageBody__DELETE, MessageBody__METADATA, MessageBody__HEADLINE, MessageBody__ATTACHMENTUPLOADED, MessageBody__JOIN, MessageBody__LEAVE, MessageBody__SYSTEM, MessageBody__DELETEHISTORY, MessageBody__REACTION, MessageBody__SENDPAYMENT, MessageBody__REQUESTPAYMENT, MessageBody__UNFURL, MessageBody__FLIP, MessageBody__PIN]
...
class MsgSummary(DataClassJsonMixin):
    ...
    unread: bool = field(metadata=config(field_name='unread'))
    prev: Optional[Optional[List[MessagePreviousPointer]]] = field(default=None, metadata=config(field_name='prev'))
    revoked_device: Optional[bool] = field(default=None, metadata=config(field_name='revoked_device'))
    offline: Optional[bool] = field(default=None, metadata=config(field_name='offline'))
    kbfs_encrypted: Optional[bool] = field(default=None, metadata=config(field_name='kbfs_encrypted'))
    is_ephemeral: Optional[bool] = field(default=None, metadata=config(field_name='is_ephemeral'))
    is_ephemeral_expired: Optional[bool] = field(default=None, metadata=config(field_name='is_ephemeral_expired'))
    e_time: Optional[gregor1.Time] = field(default=None, metadata=config(field_name='e_time'))
    reactions: Optional[ReactionMap] = field(default=None, metadata=config(field_name='reactions'))
    has_pairwise_macs: Optional[bool] = field(default=None, metadata=config(field_name='has_pairwise_macs'))
    at_mention_usernames: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='at_mention_usernames'))
    channel_mention: Optional[str] = field(default=None, metadata=config(field_name='channel_mention'))
    channel_name_mentions: Optional[Optional[List[UIChannelNameMention]]] = field(default=None, metadata=config(field_name='channel_name_mentions'))
    bot_info: Optional[MsgBotInfo] = field(default=None, metadata=config(field_name='bot_info'))
...
class MessagePlaintext(DataClassJsonMixin):
    client_header: MessageClientHeader = field(metadata=config(field_name='clientHeader'))
    message_body: MessageBody = field(metadata=config(field_name='messageBody'))
    supersedes_outbox_id: Optional[OutboxID] = field(default=None, metadata=config(field_name='supersedesOutboxID'))
...
class MsgNotification(DataClassJsonMixin):
    ...
    msg: Optional[MsgSummary] = field(default=None, metadata=config(field_name='msg'))
    error: Optional[str] = field(default=None, metadata=config(field_name='error'))
    pagination: Optional[UIPagination] = field(default=None, metadata=config(field_name='pagination'))
...
BodyPlaintext = Union[BodyPlaintext__V1, BodyPlaintext__V2, BodyPlaintext__V3, BodyPlaintext__V4, BodyPlaintext__V5, BodyPlaintext__V6, BodyPlaintext__V7, BodyPlaintext__V8, BodyPlaintext__V9, BodyPlaintext__V10]

@dataclass
class Thread(DataClassJsonMixin):
    messages: Optional[Optional[List[Message]]] = field(default=None, metadata=config(field_name='messages'))
    pagination: Optional[Pagination] = field(default=None, metadata=config(field_name='pagination'))
    offline: Optional[bool] = field(default=None, metadata=config(field_name='offline'))
    identify_failures: Optional[Optional[List[keybase1.TLFIdentifyFailure]]] = field(default=None, metadata=config(field_name='identify_failures'))
    rate_limits: Optional[Optional[List[RateLimitRes]]] = field(default=None, metadata=config(field_name='ratelimits'))
