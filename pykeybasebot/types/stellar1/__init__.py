...
class AssetActionResultLocal(DataClassJsonMixin):
    external_url: Optional[str] = field(default=None, metadata=config(field_name='externalUrl'))
    message_from_anchor: Optional[str] = field(default=None, metadata=config(field_name='messageFromAnchor'))
...
class StaticConfig(DataClassJsonMixin):
    payment_note_max_length: int = field(metadata=config(field_name='paymentNoteMaxLength'))
    request_note_max_length: int = field(metadata=config(field_name='requestNoteMaxLength'))
    public_memo_max_length: int = field(metadata=config(field_name='publicMemoMaxLength'))
...
class BundleVisibleEntryV2(DataClassJsonMixin):
    ...
    acct_bundle_revision: BundleRevision = field(metadata=config(field_name='acctBundleRevision'))
...
class AccountBundleSecretV1(DataClassJsonMixin):
    account_id: AccountID = field(metadata=config(field_name='accountID'))
    signers: Optional[Optional[List[SecretKey]]] = field(default=None, metadata=config(field_name='signers'))
...
class AssetListResult(DataClassJsonMixin):
    ...
    assets: Optional[Optional[List[Asset]]] = field(default=None, metadata=config(field_name='assets'))
...
class RelayClaimResult(DataClassJsonMixin):
    claim_stellar_id: TransactionID = field(metadata=config(field_name='claimStellarID'))
...
class EncryptedNote(DataClassJsonMixin):
    ...
    recipient: Optional[NoteRecipient] = field(default=None, metadata=config(field_name='recipient'))
...
class PaymentPath(DataClassJsonMixin):
    ...
    source_insufficient_balance: str = field(metadata=config(field_name='sourceInsufficientBalance'))
    path: Optional[Optional[List[Asset]]] = field(default=None, metadata=config(field_name='path'))
...
class AccountAssetLocal(DataClassJsonMixin):
    ...
    issuer_verified_domain: str = field(metadata=config(field_name='issuerVerifiedDomain'))
    balance_total: str = field(metadata=config(field_name='balanceTotal'))
    balance_available_to_send: str = field(metadata=config(field_name='balanceAvailableToSend'))
    worth_currency: str = field(metadata=config(field_name='worthCurrency'))
    worth: str = field(metadata=config(field_name='worth'))
    available_to_send_worth: str = field(metadata=config(field_name='availableToSendWorth'))
    desc: str = field(metadata=config(field_name='desc'))
    info_url: str = field(metadata=config(field_name='infoUrl'))
    info_url_text: str = field(metadata=config(field_name='infoUrlText'))
    show_deposit_button: bool = field(metadata=config(field_name='showDepositButton'))
    ...
    show_withdraw_button: bool = field(metadata=config(field_name='showWithdrawButton'))
    withdraw_button_text: str = field(metadata=config(field_name='withdrawButtonText'))
    reserves: Optional[Optional[List[AccountReserve]]] = field(default=None, metadata=config(field_name='reserves'))
...
class PaymentDetailsOnlyLocal(DataClassJsonMixin):
    ...
    fee_charged_description: str = field(metadata=config(field_name='feeChargedDescription'))
    path_intermediate: Optional[Optional[List[Asset]]] = field(default=None, metadata=config(field_name='pathIntermediate'))
...
class SendBannerLocal(DataClassJsonMixin):
    ...
    offer_advanced_send_form: AdvancedBanner = field(metadata=config(field_name='offerAdvancedSendForm'))
...
class RequestDetailsLocal(DataClassJsonMixin):
    ...
    currency: Optional[OutsideCurrencyCode] = field(default=None, metadata=config(field_name='currency'))
...
class AirdropStatus(DataClassJsonMixin):
    ...
    rows: Optional[Optional[List[AirdropQualification]]] = field(default=None, metadata=config(field_name='rows'))
...
class PaymentCLILocal(DataClassJsonMixin):
    ...
    display_currency: Optional[str] = field(default=None, metadata=config(field_name='displayCurrency'))
    operations: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='operations'))
    to_stellar: Optional[AccountID] = field(default=None, metadata=config(field_name='toStellar'))
    from_username: Optional[str] = field(default=None, metadata=config(field_name='fromUsername'))
    to_username: Optional[str] = field(default=None, metadata=config(field_name='toUsername'))
    to_assertion: Optional[str] = field(default=None, metadata=config(field_name='toAssertion'))
...
class BatchPaymentResult(DataClassJsonMixin):
    ...
    error: Optional[BatchPaymentError] = field(default=None, metadata=config(field_name='error'))
...
class SignXdrResult(DataClassJsonMixin):
    ...
    account_id: AccountID = field(metadata=config(field_name='accountID'))
    submit_err: Optional[str] = field(default=None, metadata=config(field_name='submitErr'))
    submit_tx_id: Optional[TransactionID] = field(default=None, metadata=config(field_name='submitTxID'))

@dataclass
class PaymentDirectPost(DataClassJsonMixin):
    from_device_id: keybase1.DeviceID = field(metadata=config(field_name='fromDeviceID'))
    ...
    to: Optional[keybase1.UserVersion] = field(default=None, metadata=config(field_name='to'))
    chat_conversation_id: Optional[ChatConversationID] = field(default=None, metadata=config(field_name='chatConversationID'))
...
class RelayClaimPost(DataClassJsonMixin):
    ...
    signed_transaction: str = field(metadata=config(field_name='signedTransaction'))
    auto_claim_token: Optional[str] = field(default=None, metadata=config(field_name='autoClaimToken'))
...
class PaymentSummaryDirect(DataClassJsonMixin):
    ...
    from_display_currency: str = field(metadata=config(field_name='fromDisplayCurrency'))
...
class RequestPost(DataClassJsonMixin):
    to_assertion: str = field(metadata=config(field_name='toAssertion'))
    amount: str = field(metadata=config(field_name='amount'))
    to_user: Optional[keybase1.UserVersion] = field(default=None, metadata=config(field_name='toUser'))
    asset: Optional[Asset] = field(default=None, metadata=config(field_name='asset'))
    currency: Optional[OutsideCurrencyCode] = field(default=None, metadata=config(field_name='currency'))
...
class RequestDetails(DataClassJsonMixin):
    ...
    to_display_amount: str = field(metadata=config(field_name='toDisplayAmount'))
    to_display_currency: str = field(metadata=config(field_name='toDisplayCurrency'))
    funding_kb_tx_id: KeybaseTransactionID = field(metadata=config(field_name='fundingKbTxID'))
    status: RequestStatus = field(metadata=config(field_name='status'))
    to_user: Optional[keybase1.UserVersion] = field(default=None, metadata=config(field_name='toUser'))
    asset: Optional[Asset] = field(default=None, metadata=config(field_name='asset'))
    currency: Optional[OutsideCurrencyCode] = field(default=None, metadata=config(field_name='currency'))
...
class BundleVisibleV2(DataClassJsonMixin):
    ...
    prev: Hash = field(metadata=config(field_name='prev'))
    accounts: Optional[Optional[List[BundleVisibleEntryV2]]] = field(default=None, metadata=config(field_name='accounts'))

@dataclass
class BundleSecretV2(DataClassJsonMixin):
    visible_hash: Hash = field(metadata=config(field_name='visibleHash'))
    accounts: Optional[Optional[List[BundleSecretEntryV2]]] = field(default=None, metadata=config(field_name='accounts'))
...
AccountBundleSecretVersioned = Union[AccountBundleSecretVersioned__V1, AccountBundleSecretVersioned__V2, AccountBundleSecretVersioned__V3, AccountBundleSecretVersioned__V4, AccountBundleSecretVersioned__V5, AccountBundleSecretVersioned__V6, AccountBundleSecretVersioned__V7, AccountBundleSecretVersioned__V8, AccountBundleSecretVersioned__V9, AccountBundleSecretVersioned__V10]
...
class Bundle(DataClassJsonMixin):
    ...
    prev: Hash = field(metadata=config(field_name='prev'))
    own_hash: Hash = field(metadata=config(field_name='ownHash'))
    account_bundles: Dict[str, AccountBundle] = field(metadata=config(field_name='accountBundles'))
    accounts: Optional[Optional[List[BundleEntry]]] = field(default=None, metadata=config(field_name='accounts'))
...
class WalletAccountLocal(DataClassJsonMixin):
    ...
    account_mode_editable: bool = field(metadata=config(field_name='accountModeEditable'))
...
class PaymentLocal(DataClassJsonMixin):
    ...
    tx_id: TransactionID = field(metadata=config(field_name='txID'))
    time: TimeMs = field(metadata=config(field_name='time'))
    status_simplified: PaymentStatus = field(metadata=config(field_name='statusSimplified'))
    status_description: str = field(metadata=config(field_name='statusDescription'))
    status_detail: str = field(metadata=config(field_name='statusDetail'))
    ...
    to_assertion: str = field(metadata=config(field_name='toAssertion'))
    original_to_assertion: str = field(metadata=config(field_name='originalToAssertion'))
    note: str = field(metadata=config(field_name='note'))
    note_err: str = field(metadata=config(field_name='noteErr'))
    source_amount_max: str = field(metadata=config(field_name='sourceAmountMax'))
    source_amount_actual: str = field(metadata=config(field_name='sourceAmountActual'))
    ...
    issuer_account_id: Optional[AccountID] = field(default=None, metadata=config(field_name='issuerAccountID'))
    to_account_id: Optional[AccountID] = field(default=None, metadata=config(field_name='toAccountID'))
    operations: Optional[Optional[List[str]]] = field(default=None, metadata=config(field_name='operations'))
    inflation_source: Optional[str] = field(default=None, metadata=config(field_name='inflationSource'))
    trustline: Optional[PaymentTrustlineLocal] = field(default=None, metadata=config(field_name='trustline'))
...
class BuildPaymentResLocal(DataClassJsonMixin):
    ...
    sending_intention_xlm: bool = field(metadata=config(field_name='sendingIntentionXLM'))
    amount_available: str = field(metadata=config(field_name='amountAvailable'))
    banners: Optional[Optional[List[SendBannerLocal]]] = field(default=None, metadata=config(field_name='banners'))
...
class InflationDestinationResultLocal(DataClassJsonMixin):
    ...
    destination: Optional[AccountID] = field(default=None, metadata=config(field_name='destination'))
    known_destination: Optional[PredefinedInflationDestination] = field(default=None, metadata=config(field_name='knownDestination'))
...
class RecipientTrustlinesLocal(DataClassJsonMixin):
    ...
    trustlines: Optional[Optional[List[Balance]]] = field(default=None, metadata=config(field_name='trustlines'))
...
class PaymentPathLocal(DataClassJsonMixin):
    ...
    destination_account: AccountID = field(metadata=config(field_name='destinationAccount'))
    full_path: PaymentPath = field(metadata=config(field_name='fullPath'))

@dataclass
class PaymentOrErrorCLILocal(DataClassJsonMixin):
    payment: Optional[PaymentCLILocal] = field(default=None, metadata=config(field_name='payment'))
...
class OwnAccountCLILocal(DataClassJsonMixin):
    ...
    name: str = field(metadata=config(field_name='name'))
    account_mode: AccountMode = field(metadata=config(field_name='accountMode'))
    balance: Optional[Optional[List[Balance]]] = field(default=None, metadata=config(field_name='balance'))
    exchange_rate: Optional[OutsideExchangeRate] = field(default=None, metadata=config(field_name='exchangeRate'))
...
class BatchResultLocal(DataClassJsonMixin):
    ...
    wait_payments_duration_ms: TimeMs = field(metadata=config(field_name='waitPaymentsDurationMs'))
    wait_chat_duration_ms: TimeMs = field(metadata=config(field_name='waitChatDurationMs'))
    ...
    avg_success_duration_ms: TimeMs = field(metadata=config(field_name='avgSuccessDurationMs'))
    avg_direct_duration_ms: TimeMs = field(metadata=config(field_name='avgDirectDurationMs'))
    avg_relay_duration_ms: TimeMs = field(metadata=config(field_name='avgRelayDurationMs'))
    avg_error_duration_ms: TimeMs = field(metadata=config(field_name='avgErrorDurationMs'))
    payments: Optional[Optional[List[BatchPaymentResult]]] = field(default=None, metadata=config(field_name='payments'))
...
class ValidateStellarURIResultLocal(DataClassJsonMixin):
    ...
    memo_type: str = field(metadata=config(field_name='memoType'))
    display_amount_fiat: str = field(metadata=config(field_name='displayAmountFiat'))
    available_to_send_native: str = field(metadata=config(field_name='availableToSendNative'))
    available_to_send_fiat: str = field(metadata=config(field_name='availableToSendFiat'))
    signed: bool = field(metadata=config(field_name='signed'))

@dataclass
class PaymentOp(DataClassJsonMixin):
    to: Optional[keybase1.UserVersion] = field(default=None, metadata=config(field_name='to'))
    direct: Optional[DirectOp] = field(default=None, metadata=config(field_name='direct'))
...
class PaymentSummaryRelay(DataClassJsonMixin):
    ...
    display_amount: Optional[str] = field(default=None, metadata=config(field_name='displayAmount'))
    display_currency: Optional[str] = field(default=None, metadata=config(field_name='displayCurrency'))
    claim: Optional[ClaimSummary] = field(default=None, metadata=config(field_name='claim'))
...
class AccountDetails(DataClassJsonMixin):
    ...
    display_currency: str = field(metadata=config(field_name='displayCurrency'))
    balances: Optional[Optional[List[Balance]]] = field(default=None, metadata=config(field_name='balances'))
    reserves: Optional[Optional[List[AccountReserve]]] = field(default=None, metadata=config(field_name='reserves'))
    read_transaction_id: Optional[TransactionID] = field(default=None, metadata=config(field_name='readTransactionID'))
    inflation_destination: Optional[AccountID] = field(default=None, metadata=config(field_name='inflationDestination'))
...
BundleSecretVersioned = Union[BundleSecretVersioned__V1, BundleSecretVersioned__V2, BundleSecretVersioned__V3, BundleSecretVersioned__V4, BundleSecretVersioned__V5, BundleSecretVersioned__V6, BundleSecretVersioned__V7, BundleSecretVersioned__V8, BundleSecretVersioned__V9, BundleSecretVersioned__V10]

@dataclass
class PaymentOrErrorLocal(DataClassJsonMixin):
    payment: Optional[PaymentLocal] = field(default=None, metadata=config(field_name='payment'))
    err: Optional[str] = field(default=None, metadata=config(field_name='err'))
...
class PaymentMultiPost(DataClassJsonMixin):
    ...
    signed_transaction: str = field(metadata=config(field_name='signedTransaction'))
    batch_id: str = field(metadata=config(field_name='batchID'))
    operations: Optional[Optional[List[PaymentOp]]] = field(default=None, metadata=config(field_name='operations'))
...
PaymentSummary = Union[PaymentSummary__STELLAR, PaymentSummary__DIRECT, PaymentSummary__RELAY]

@dataclass
class PaymentsPageLocal(DataClassJsonMixin):
    payments: Optional[Optional[List[PaymentOrErrorLocal]]] = field(default=None, metadata=config(field_name='payments'))
    cursor: Optional[PageCursor] = field(default=None, metadata=config(field_name='cursor'))
    oldest_unread: Optional[PaymentID] = field(default=None, metadata=config(field_name='oldestUnread'))
...
class PaymentsPage(DataClassJsonMixin):
    payments: Optional[Optional[List[PaymentSummary]]] = field(default=None, metadata=config(field_name='payments'))
    cursor: Optional[PageCursor] = field(default=None, metadata=config(field_name='cursor'))
    oldest_unread: Optional[TransactionID] = field(default=None, metadata=config(field_name='oldestUnread'))
...
class DetailsPlusPayments(DataClassJsonMixin):
    ...
    pending_payments: Optional[Optional[List[PaymentSummary]]] = field(default=None, metadata=config(field_name='pendingPayments'))
