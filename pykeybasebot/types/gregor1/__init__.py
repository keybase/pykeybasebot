...
class MsgRange(DataClassJsonMixin):
    ...
    skip_msg_i_ds: Optional[Optional[List[MsgID]]] = field(default=None, metadata=config(field_name='skipMsgIDs'))
...
class Item(DataClassJsonMixin):
    ...
    body: Body = field(metadata=config(field_name='body'))
    remind_times: Optional[Optional[List[TimeOrOffset]]] = field(default=None, metadata=config(field_name='remindTimes'))

@dataclass
class ConnectedUser(DataClassJsonMixin):
    uid: UID = field(metadata=config(field_name='uid'))
    devices: Optional[Optional[List[ConnectedDevice]]] = field(default=None, metadata=config(field_name='devices'))

@dataclass
class Dismissal(DataClassJsonMixin):
    msg_i_ds: Optional[Optional[List[MsgID]]] = field(default=None, metadata=config(field_name='msgIDs'))
    ranges: Optional[Optional[List[MsgRange]]] = field(default=None, metadata=config(field_name='ranges'))
...
class State(DataClassJsonMixin):
    items: Optional[Optional[List[ItemAndMetadata]]] = field(default=None, metadata=config(field_name='items'))

@dataclass
class StateUpdateMessage(DataClassJsonMixin):
    md: Metadata = field(metadata=config(field_name='md'))
    creation: Optional[Item] = field(default=None, metadata=config(field_name='creation'))
    dismissal: Optional[Dismissal] = field(default=None, metadata=config(field_name='dismissal'))
...
class InBandMessage(DataClassJsonMixin):
    state_update: Optional[StateUpdateMessage] = field(default=None, metadata=config(field_name='stateUpdate'))
    state_sync: Optional[StateSyncMessage] = field(default=None, metadata=config(field_name='stateSync'))

@dataclass
class ReminderSet(DataClassJsonMixin):
    more_reminders_ready: bool = field(metadata=config(field_name='moreRemindersReady'))
    reminders: Optional[Optional[List[Reminder]]] = field(default=None, metadata=config(field_name='reminders'))

@dataclass
class Message(DataClassJsonMixin):
    oobm: Optional[OutOfBandMessage] = field(default=None, metadata=config(field_name='oobm'))
    ibm: Optional[InBandMessage] = field(default=None, metadata=config(field_name='ibm'))

@dataclass
class SyncResult(DataClassJsonMixin):
    hash: str = field(metadata=config(field_name='hash'))
    msgs: Optional[Optional[List[InBandMessage]]] = field(default=None, metadata=config(field_name='msgs'))
